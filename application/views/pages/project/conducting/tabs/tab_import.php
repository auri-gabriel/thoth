...
<div class="tab-pane container-fluid py-4" role="tabpanel" id="tab_import">
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="input-group">
                                ...
                                <label class="input-group-text" id="name_bib_upload" for="upload_bib"></label>
    ...
    <div class="d-flex justify-content-between align-items-center mt-4 mb-5">
        <a href="#tab_extraction" class="btn btn-outline-secondary" data-bs-toggle="tooltip" title="Go to previous step"><span class="fas fa-backward"></span> Previous</a>
