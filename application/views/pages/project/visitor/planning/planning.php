<div class="card">
	...
	<div class="card-body">
		...
		<ul class="nav nav-pills nav-justified flex-column flex-sm-row">
			<li class="nav-item">
				<a data-bs-toggle="pill" class="nav-link active flex-sm-fill text-sm-center" href="#tab_overall">Overall information <i class="fas fa-info-circle"></i></a>
			</li>
			<li class="nav-item">
				<a data-bs-toggle="pill" class="nav-link flex-sm-fill text-sm-center" href="#tab_research">Research Questions <i class="fas fa-graduation-cap"></i></a>
			</li>
			<li class="nav-item">
				<a data-bs-toggle="pill" class="nav-link flex-sm-fill text-sm-center" href="#tab_databases">Data Bases <i class="fas fa-database"></i></a>
			</li>
			<li class="nav-item">
				<a data-bs-toggle="pill" class="nav-link flex-sm-fill text-sm-center" href="#tab_search_string">Search
					String <i class="fas fa-search-plus"></i></a>
			</li>
			<li class="nav-item">
				<a data-bs-toggle="pill" class="nav-link flex-sm-fill text-sm-center" href="#tab_search_strategy">Search Strategy <i class="fas fa-chess"></i></a>
			</li>
			<li class="nav-item">
				<a data-bs-toggle="pill" class="nav-link flex-sm-fill text-sm-center" href="#tab_criteria">Criteria <i class="fas fa-check-double"></i></a>
			</li>
			<li class="nav-item">
				<a data-bs-toggle="pill" class="nav-link flex-sm-fill text-sm-center" href="#tab_quality">Quality Assessment <i class="far fa-star"></i></a>
			</li>
			<li class="nav-item">
				<a data-bs-toggle="pill" class="nav-link flex-sm-fill text-sm-center" href="#tab_data">Data Extraction <i class="fas fa-table"></i></a>
			</li>
		</ul>
	</div>
