	...
	<div class="card">
		...
		<div class="card-body">
			...
			<ul class="nav nav-pills nav-justified flex-column flex-sm-row">
				...
				<?php if ($this->session->level == "4") { ?>
					<li class="nav-item">
						<a class="nav-link flex-sm-fill text-sm-center" href="<?= site_url('projects/' . $project->get_id() . '/study-selection-admin') ?>">Review
							Study
				...
				<?php if ($this->session->level == "4") { ?>
					<li class="nav-item">
						<a class="nav-link active flex-sm-fill text-sm-center" href="<?= site_url('projects/' . $project->get_id() . '/quality-admin') ?>">Review
