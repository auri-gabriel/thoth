	...
	<div class="card">
		...
		<div class="card-body">
		   ...
		   document.addEventListener('DOMContentLoaded', function () {
			   ...
			   // Import tab chart
			   if (document.querySelector('#tab_import #papers_per_database')) {
			   ...
			   // Selection tab chart
			   if (document.querySelector('#tab_selection #papers_per_selection')) {
			   ...
			   // Quality tab charts
			   if (document.querySelector('#tab_quality #papers_per_quality')) {
			   ...
			   if (document.querySelector('#tab_quality #papers_gen_score')) {
