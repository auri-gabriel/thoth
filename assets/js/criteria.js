...
function modal_criteria_inclusion(value) {
	...
	$("#modal_inclusion_criteria #edit_description_criteria_in").val(
		row.data()[2],
	);
...
function modal_criteria_exclusion(value) {
	...
	$("#modal_exclusion_criteria #edit_description_criteria_ex").val(
		row.data()[2],
	);
...
function edit_criteria_inclusion() {
	...
	let description = $(
		"#modal_inclusion_criteria #edit_description_criteria_in",
	).val();
	let type = $(
		"#modal_inclusion_criteria #edit_select_type_inclusion option:selected",
	).val();
...
function edit_criteria_exclusion() {
	...
	let description = $(
		"#modal_exclusion_criteria #edit_description_criteria_ex",
	).val();
	let type = $(
		"#modal_exclusion_criteria #edit_select_type_exclusion option:selected",
	).val();
